...
class FlashcardView extends ConsumerStatefulWidget {
  ...
  const FlashcardView({super.key, required this.contentJson, required this.onComplete});
      ...
      child: Column(
        children: [
                  ...
                  Center(
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            _isFlipped ? getLocalized(context, card['back']) : getLocalized(context, card['front']),
                            style: Theme.of(context).textTheme.headlineMedium?.copyWith(
                              fontWeight: FontWeight.bold,
                              color: _isFlipped ? Colors.blue.shade900 : Colors.black87,
                            ),
                          ...
                          if (_isFlipped && card['example'] != null) ...[
                            ...
                            Text(
                              getLocalized(context, card['example']), // Localized Example
          ...
          FilledButton.icon(
            ...
            label: Text(_currentIndex < _cards.length - 1 ? l10n.nextCard : l10n.finish),
          ),
